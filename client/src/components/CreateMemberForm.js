			...
			<div className={mformcss.container}>
				...
				<form onSubmit={this.handleFormSubmit}>
					<div className={mformcss.formGroup}>
						...
						<input type="text" id="name" name="name"  onChange={this.state.bookName} placeholder="제목을 입력하세요"/>
						<label for="bookNum">도서 번호</label>
						<input type="text" id="bookNum" name="bookNum" onChange={this.state.bookNumber} placeholder="번호를 입력하세요"/>
						<label for="borrower">빌린 사람</label>
						<input type="text" id="borrower" name="borrower" onChange={this.state.borrower} placeholder="이름을 입력하세요"/>
					</div>
